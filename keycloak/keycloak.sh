...
docker run -p 9999:8080 -e KEYCLOAK_USER=admin -e KEYCLOAK_PASSWORD=password -e KEYCLOAK_IMPORT=/tmp/demo-realm.json -v $(pwd)/demo-realm.json:/tmp/demo-realm.json jboss/keycloak:7.0.0
